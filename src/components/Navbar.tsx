        ...
        <div className="flex items-center justify-between h-18">
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-xl text-xs font-semibold text-emerald-900 bg-emerald-50/90 hover:bg-emerald-100/90 border border-emerald-200/90 transition-all flex items-center gap-2 cursor-pointer shadow-2xs group"
              title="Verified Kitchen Location: Gachibowli, Hyderabad. Click for live delivery & takeaway details."
            >
              ...
              <div className="flex flex-col text-left leading-tight py-0.5">
                <span className="font-bold text-emerald-950 text-xs flex items-center gap-1">
                  ...
                  <span className="text-[9px] px-1 py-0.2 bg-emerald-200/70 text-emerald-900 rounded font-black uppercase tracking-wider">
                    LIVE
                  </span>
                </span>
                <span className="text-[10px] text-emerald-700 font-normal">
                  Delivering Now • 25–35 min
                </span>
              </div>
            </button>
            ...
            >
              <span className="flex items-center gap-1.5">
                <MapPin className="w-4 h-4" /> Order Tracking
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <div className="text-[10px] text-emerald-700 font-normal">
                  Kitchen Live • Delivering Now (25–35m)
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500">
                    {BUSINESS_INFO.restaurantName} • Starters4U
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="py-4 space-y-3 text-xs text-slate-600">
              ...
              <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200/80 space-y-1">
                ...
                <p className="text-xs text-slate-700 leading-relaxed">
                  Serving <strong>Gachibowli</strong>, <strong>Financial District</strong>, <strong>Kondapur</strong>, <strong>Hitec City</strong>, and nearby neighborhoods within a 5km radius.
                </p>
              </div>
              ...
              <div className="p-3 rounded-xl bg-amber-50/70 border border-amber-200/70 flex items-center justify-between text-[11px] text-amber-900">
                <span className="flex items-center gap-1.5 font-medium">
                  ...
                  Kitchen Operating Hours: 11:00 AM – 11:30 PM (Daily)
                </span>
